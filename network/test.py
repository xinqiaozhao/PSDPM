...
class Net(nn.Module):
    ...
    def Bank(self, sem_feature):
        ...
        query_projector = self.Q(sem_feature.clone().detach()) # 16, 128, 32, 32
    ...
    def prototype(self, norm_cam, feature, valid_mask):
        ...
        prototype = F.adaptive_avg_pool2d(crop_feature.view(-1,c,h,w), (1,1)).view(n, self.num_cls, c, 1, 1)
        if n == 1:
